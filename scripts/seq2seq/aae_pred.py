...
model = load_model("aae/smiles2smiles.h5")
...
smiles_to_latent_model = load_model("aae/simple_smi2lat.h5")
x_latent = smiles_to_latent_model.predict(X_train)
print(x_latent.shape)

'''
with open('validation_set_latent2.csv', 'w', newline = "") as csvfile:
 fieldnames = ['Pred']
 writer = csv.writer(csvfile,delimiter=',',)
 for p in x_latent: writer.writerow(p)
'''
